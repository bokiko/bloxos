    ...
    <div>
      ...
      {loading ? (
        ...
        <div className="bg-slate-800/50 backdrop-blur-sm rounded-xl border border-slate-700/50 p-12 text-center">
          ...
          <p className="text-slate-400 mb-4">No pools configured yet</p>
          <button
            onClick={openCreateModal}
            ...
            >
              <div className="flex items-start justify-between">
                <div className="flex items-center gap-4">
                  <div className={`w-12 h-12 rounded-xl ${getCoinColor(pool.coin)} flex items-center justify-center font-bold text-white`}>
                    {pool.coin.slice(0, 3)}
                  </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div>
                ...
                <input
                  ...
                  placeholder="stratum+tcp://eth.2miners.com:2020"
              ...
              <div>
                ...
                <input
                  ...
                  placeholder="stratum+tcp://eth.2miners.com:2121"
                  className="w-full px-4 py-2.5 bg-slate-900/50 border border-slate-700 rounded-lg focus:outline-none focus:ring-2 focus:ring-blox-500 font-mono text-sm"
                />
              </div>
